...
class i18n {
  ...
  static const Map fr_dict = {
    ...
    "htp_desc": "Ce jeu consiste à trouver un nom commun (de niveau A2) choisit au hasard chaque jour, tout cela en un minimum d'essaies ! L'indice de similarité vous indique si vous êtes sur la bonne voie !",
    "chnage_l": "Changer de langue ?",
    "propose_fw": "Propose un premier mot !",
    "day_nb": "Jour n°",
    "ldb": "Classement",
  ...
  static const Map en_dict = {
    ...
    "htp_desc": "This game consists of finding a common name (A2 level) chosen at random each day, all in a minimum of tries! The similarity index tells you if you are on the right track!",
